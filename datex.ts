...
module datex {
  ...
  export function dateOffsetDay(date:Date, offsetDay?:number): Date{
  ...
  // console.error("dateOffsetDay", dateOffsetDay(new Date(), 3));
  ...
  // console.error("getFirstDayOfMonth", getFirstDayOfMonth(new Date()));
  // console.error("getLastSunday", getLastSunday(getFirstDayOfMonth(new Date())));
  // console.error("------");
  //
